...
//static const char *dmenucmd[] = { "rofi -show drun", "-font", rofifont, "-theme gruvbox-dark-soft -show-icons", NULL };
//static const char *dmenucmd[] = { "rofi -show drun -font iosevka 12 -theme gruvbox-dark-soft -show-icons", NULL };
//rofi -show drun -font "iosevka 12" -theme gruvbox-dark-soft -show-icons
